...
class ModuleMigrateFreshCommand extends Command
{
    protected $signature = 'module:migrate:fresh
        {module? : The module to fresh migrate}
        {--seed : Run module seeders after migration}
        {--force : Force the operation to run in production}';

    protected $description = 'Drop all tables and re-run module migrations from scratch';
    ...
    public function handle(ModuleManager $manager): int
    {
        ...
        foreach ($modules as $moduleName) {
            ...
            $this->info("Fresh migrating module [{$moduleName}]...");
